...
function AddArchivedOrder({ archives, onUpdate }: { archives: DailyArchive[]; onUpdate: (archive: DailyArchive) => void }) {
...
export function App() {
  ...
  return <div className={`water-app ${activeSection === "Repartidor" ? "rider-mode" : ""}`}>
    ...
    <main className="workspace" id="top">
      ...
      {activeSection === "Reportes" && <AddArchivedOrder archives={dailyArchives} onUpdate={updateDailyArchive} />}
